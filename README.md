...
```bash
curl -sSL https://gist.githubusercontent.com/TVKain/10cc2eae8f947e0fa578f5599f920301/raw/75737defac0841e5ee515f561b5f1a304a2e33d6/quickstart.sh | bash
```

This script will:
1. Install required dependencies (git, build-essential, gdb-multiarch, qemu-system-riscv, gcc-riscv64-linux-gnu, binutils-riscv64-linux-gnu)
2. Clone this repository
3. Build the xv6 kernel
4. Test the installation with QEMU

**Verified on:** WSL2 with Ubuntu 26.04 LTS

For manual installation instructions, see the detailed setup guide in the repository.
